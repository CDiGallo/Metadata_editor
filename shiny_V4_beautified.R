...
#####################
# ui <- fluidPage(
#   textInput("caption", "Caption", "https://energy.ld.admin.ch/sfoe/bfe_ogd17_fuellungsgrad_speicherseen/5"),
#   verbatimTextOutput("value"),
#   theme = shinytheme("sandstone"),
#   
#   # header
#   headerPanel("LINDA's Metadata Editor"),
#   
#   sidebarLayout(
#     # sidebar for form
#     sidebarPanel(
...
#   dashboardSidebar( 
#   sidebarMenu(
#     menuItem("Predict!", tabName = "model", icon = icon("wand-magic-sparkles"),
#              textInput("caption", "Caption", "https://energy.ld.admin.ch/sfoe/bfe_ogd17_fuellungsgrad_speicherseen/5"),
#              textInput("s", "Subject",""),
#              textInput("Property", "Property",""),
#              textInput("URI", "URI",""),
